...
HWKey stdin_poll_key(void)
{
    ...
    switch (ch)
    {
        case 's': return HW_KEY_SELECT;
        case 'b': return HW_KEY_BACK;
        case 'c': return HW_KEY_CANCEL;
        case 'r': return HW_KEY_ROTA;
        case 't': return HW_KEY_ROTB;
        default:  return HW_KEY_INVALID;
    }
}
