...
ActionContext menu_actions_resolve(ActionID action_id)
{
    ...
    case CTX_BRIGHTNESS:
        ...
        {
            CAT_BRIGHTNESS, BRT_SHOW
        };

    case CTX_DISP1_T1:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_T1
        };
    case CTX_DISP1_T2:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_T2
        };
    case CTX_DISP1_T1MINUST2:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_T1MINUST2
        };
    case CTX_DISP1_T2MINUST1:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_T2MINUST1
        };
    case CTX_DISP1_DELTAT1:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_DELTAT1
        };
    case CTX_DISP1_DELTAT2:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_DELTAT2
        };
    case CTX_DISP1_MINT1:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_MINT1
        };
    case CTX_DISP1_MINT2:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_MINT2
        };
    case CTX_DISP1_MAXT1:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_MAXT1
        };
    case CTX_DISP1_MAXT2:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_MAXT2
        };
    case CTX_DISP1_COUNT1:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_COUNT1
        };
    case CTX_DISP1_COUNT2:
        return (ActionContext)
        {
            CAT_DISPLAY1, DISPLAY_COUNT2
        };

    case CTX_DISP2_T1:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_T1
        };
    case CTX_DISP2_T2:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_T2
        };
    case CTX_DISP2_T1MINUST2:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_T1MINUST2
        };
    case CTX_DISP2_T2MINUST1:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_T2MINUST1
        };
    case CTX_DISP2_DELTAT1:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_DELTAT1
        };
    case CTX_DISP2_DELTAT2:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_DELTAT2
        };
    case CTX_DISP2_MINT1:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_MINT1
        };
    case CTX_DISP2_MINT2:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_MINT2
        };
    case CTX_DISP2_MAXT1:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_MAXT1
        };
    case CTX_DISP2_MAXT2:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_MAXT2
        };
    case CTX_DISP2_COUNT1:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_COUNT1
        };
    case CTX_DISP2_COUNT2:
        return (ActionContext)
        {
            CAT_DISPLAY2, DISPLAY_COUNT2
        };

    case CTX_CELSIUS:
        return (ActionContext)
        {
            CAT_UNITS, UNITS_CELSIUS
        };
    case CTX_FAHRENHEIT:
        return (ActionContext)
        {
            CAT_UNITS, UNITS_FAHRENHEIT
        };
    case CTX_KELVIN:
        return (ActionContext)
        {
            CAT_UNITS, UNITS_KELVIN
        };

    case CTX_SCALE2:
        return (ActionContext)
        {
            CAT_RESOLUTION, RES_SCALE2
        };
    case CTX_SCALE3:
        return (ActionContext)
        {
            CAT_RESOLUTION, RES_SCALE3
        };
    case CTX_SCALE4:
        return (ActionContext)
        {
            CAT_RESOLUTION, RES_SCALE4
        };

    case CTX_BRT_MAIN_VALUE:
        return (ActionContext)
        {
            CAT_BRIGHTNESS, BRT_MAIN
        };
    case CTX_BRT_OTHER_VALUE:
        return (ActionContext)
        {
            CAT_BRIGHTNESS, BRT_OTHER
        };

    case CTX_FRONT:
        return (ActionContext)
        {
            CAT_SOCKETS, SOCKETS_FRONT
        };
    case CTX_BACK:
        return (ActionContext)
        {
            CAT_SOCKETS, SOCKETS_BACK
        };

    case CTX_PROBE_A_IDX0:
        return (ActionContext)
        {
            CAT_PROBE_A, PROBE_IDX0
        };
    case CTX_PROBE_A_IDX1:
        return (ActionContext)
        {
            CAT_PROBE_A, PROBE_IDX1
        };
    case CTX_PROBE_A_IDX2:
        return (ActionContext)
        {
            CAT_PROBE_A, PROBE_IDX2
        };

    case CTX_PROBE_B_IDX0:
        return (ActionContext)
        {
            CAT_PROBE_B, PROBE_IDX0
        };
    case CTX_PROBE_B_IDX1:
        return (ActionContext)
        {
            CAT_PROBE_B, PROBE_IDX1
        };
    case CTX_PROBE_B_IDX2:
        return (ActionContext)
        {
            CAT_PROBE_B, PROBE_IDX2
        };

    case CTX_TRANSMIT_ON:
        return (ActionContext)
        {
            CAT_TRANSMIT, TRANSMIT_ON
        };
    case CTX_TRANSMIT_OFF:
        return (ActionContext)
        {
            CAT_TRANSMIT, TRANSMIT_OFF
        };

    case CTX_SETTINGS_SAVE:
        return (ActionContext)
        {
            CAT_SETTINGS, SETTINGS_SAVE
        };
    case CTX_SETTINGS_DISCARD:
        return (ActionContext)
        {
            CAT_SETTINGS, SETTINGS_DISCARD
        };
    case CTX_SETTINGS_DEFAULT:
        return (ActionContext)
        {
            CAT_SETTINGS, SETTINGS_DEFAULT
        };

    case CTX_PROBE_SAVE:
        return (ActionContext)
        {
            CAT_PROBE_DB, SETTINGS_SAVE
        };
    case CTX_PROBE_DISCARD:
        return (ActionContext)
        {
            CAT_PROBE_DB, SETTINGS_DISCARD
        };
    case CTX_PROBE_DEFAULT:
        return (ActionContext)
        {
            CAT_PROBE_DB, SETTINGS_DEFAULT
        };

    case CTX_PROBE_CORE_IDX:
        return (ActionContext)
        {
            CAT_PROBE_CORE, PROBE_CORE_IDX
        };
    case CTX_PROBE_CORE_PARAM:
        return (ActionContext)
        {
            CAT_PROBE_CORE, PROBE_CORE_PARAM
        };
    case CTX_PROBE_CORE_VALUE:
        return (ActionContext)
        {
            CAT_PROBE_CORE, PROBE_CORE_VALUE
        };

    case CTX_PROBE_CF_IDX:
        return (ActionContext)
        {
            CAT_PROBE_CF, PROBE_CF_IDX
        };
    case CTX_PROBE_CF_PARAM:
        return (ActionContext)
        {
            CAT_PROBE_CF, PROBE_CF_PARAM
        };
    case CTX_PROBE_CF_VALUE:
        return (ActionContext)
        {
            CAT_PROBE_CF, PROBE_CF_VALUE
        };
